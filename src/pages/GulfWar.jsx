  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-14">
      ...
      >
        ...
        <h1 className="mt-4 font-display text-[clamp(3rem,7vw,6rem)] leading-[0.85] text-accent">
          The Gulf War
        </h1>
        <p className="mt-4 max-w-3xl text-lg italic text-sand/90">
