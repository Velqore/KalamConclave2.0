...
const SETTING_LABELS = {
  ...
  upi_id: 'UPI ID',
  payment_url: 'Payment URL (opens on QR click)',
...
const SETTING_HELPERS = {
  ...
  payment_url: 'Full web URL that opens in a new tab when the user clicks the QR code (e.g. a Razorpay/UPI payment page link)',
